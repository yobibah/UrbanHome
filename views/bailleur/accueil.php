        ...
        <main class="flex-1 p-8">
            ...
            <div class="bg-white p-6 rounded-xl shadow-md">
                ...
                <div class="space-x-4">
                  ...
                  <a href="/Nouvelle-Propiete?id=<?= $encodedId ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700"> Ajouter un projet</a>
                    ...
                    <a href="Mon-profil<?= $encodedId?>" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700">Mon profil</a>
                </div>
            </div>
        </main>
    </div>
